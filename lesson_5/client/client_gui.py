from PyQt5.QtWidgets import QMainWindow, qApp, QMessageBox, QApplication, QListView, QPushButton, QAction, QToolTip
...
from lesson_5.client.add_contact import AddContactDialog
from lesson_5.client.client import CommandsRequest
from lesson_5.client.client_storage import ClientStorage
from lesson_5.client.del_contact import DelContactDialog
from lesson_5.client.main_window_conv import Ui_MainClientWindow
from lesson_5.common.errors import ServerError
from lesson_5.client import client

# from lesson_5.client.transport import ClientTransport
# from lesson_5.client.start_dialog import UserNameDialog
...
class MainWindowClient(QMainWindow):
    ...
    def add_contact_window(self):
        ...
        select_dialog = AddContactDialog(self.commands, self.database)
    ...
    def add_contact(self, new_contact):
        try:
            self.commands.add_contact(new_contact)
    ...
    def delete_contact(self, item):
        ...
        try:
            self.commands.del_contact(selected)
        except ServerError as err:
            self.messages.critical(self, 'Ошибка сервера', err.text)
        except OSError as err:
            if err.errno:
...
if __name__ == '__main__':
    ...
    soc = client.main()
    command = CommandsRequest(database=data_base, user_name="user", server_socket=soc)
    window = MainWindowClient(database=data_base, commands=command)
